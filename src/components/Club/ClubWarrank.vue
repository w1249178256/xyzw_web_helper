            ...
            <div class="battle-records-content">
                ...
                <div v-else-if="battleRecords1 && battleRecords1.legionRankList" ref="exportDom" class="records-list">
                    <div class="records-info">
                        <n-tag type="info">查询日期: {{ formatTimestamp(inputDate1) }}</n-tag>
                    </div>
...
import {
    getLastSaturday,
    formatTimestamp,
    // formatTimestamp1, // 修正点 1: 移除错误的导入 (已确认移除)
    parseBattleResult,
    parseAttackType,
...
// 查询战绩
    const fetchBattleRecords1 = async () => {
        ...
        loading1.value = true
        queryDate.value = formatTimestamp(inputDate1.value) // 修正点 3: 改为 formatTimestamp
